...
const SERIES_MAP = {
  // Shadow Covenant Series
  "Midnight's Allure":           "Shadow Covenant",
  "Phantasmal Revelry":          "Shadow Covenant",
  "Sanguine Steward":            "Shadow Covenant",
  "Phantom Mirage":              "Shadow Covenant",
  "Duchess of Tides":            "Shadow Covenant",
  // Eternal Seasons Series
  "Arrow of Spring":             "Eternal Seasons",
  "Herald of Autumn":            "Eternal Seasons",
  // Rolling Tides Series
  "Phantom Current":             "Rolling Tides",
  "Seasworn Oracle":             "Rolling Tides",
  // SpongeBob SquarePants Collab
  "SpongeBob":                   "SpongeBob SquarePants Collab",
  "Patrick":                     "SpongeBob SquarePants Collab",
  // Soul Vessels Series
  "Vessel of Gluttony":          "Soul Vessels",
  "Vessel of Pride":             "Soul Vessels",
  "Vessel of Ruin":              "Soul Vessels",
  "Vessel of Deceit":            "Soul Vessels",
  "Vessel of Rage":              "Soul Vessels",
  // Nexus Sea Series
  "The Beacon":                  "Nexus Sea",
  "The Annihilator":             "Nexus Sea",
  "The Navigator":               "Nexus Sea",
  // P.ACE Series
  "P.ACE Fanny":                 "P.ACE",
  "P.ACE Cici":                  "P.ACE",
  "P.ACE Zhuxin":                "P.ACE",
  // Mystic Meow Series
  "Meowkin Warden":              "Mystic Meow",
  "Meowkin Hunter":              "Mystic Meow",
  "Meowkin Tracker":             "Mystic Meow",
  // Metro Zero Series
  "Invoker's Command":           "Metro Zero",
  "Invoker's Restraint":         "Metro Zero",
  "Invoker's Flame":             "Metro Zero",
  // The Aspirants Series
  "Twilight Star":               "The Aspirants",
  "Daybreak Halo":               "The Aspirants",
  "Tech Tensai":                 "The Aspirants",
  "Deadeye Spectre":             "The Aspirants",
  "Cyber Cherubin":              "The Aspirants",
  "Mecha Maiden":                "The Aspirants",
  "Blade of Kibou":              "The Aspirants",
  "Miss Hikari":                 "The Aspirants",
  // MLBB × NARUTO Collab
  "Naruto Uzumaki":              "MLBB × NARUTO Collab",
  "Sasuke Uchiha":               "MLBB × NARUTO Collab",
  "Sakura Haruno":               "MLBB × NARUTO Collab",
  "Minato Namikaze":             "MLBB × NARUTO Collab",
  "Itachi Uchiha":               "MLBB × NARUTO Collab",
  "Kakashi Hatake":              "MLBB × NARUTO Collab",
  // Neobeasts Series
  "Neobeast Pharsa":             "Neobeasts",
  "Neobeast Brody":              "Neobeasts",
  "Neobeast Ling":               "Neobeasts",
  "Neobeast Fredrinn":           "Neobeasts",
  "Neobeast Lylia":              "Neobeasts",
  "Neo Ling":                    "Neobeasts",
  // HUNTER×HUNTER Collab
  "Gon":                         "HUNTER×HUNTER Collab",
  "Hisoka":                      "HUNTER×HUNTER Collab",
  "Killua":                      "HUNTER×HUNTER Collab",
  "Kurapika":                    "HUNTER×HUNTER Collab",
  // Kishin Densetsu Series
  "Strings of Fate":             "Kishin Densetsu",
  "Breath of Naraka":            "Kishin Densetsu",
  "Guardian of the Shrine":      "Kishin Densetsu",
  // The Exorcists Series
  "Exorcist Yu Zhong":           "The Exorcists",
  "Exorcist Kagura":             "The Exorcists",
  "Exorcist Granger":            "The Exorcists",
  "Exorcist Hayabusa":           "The Exorcists",
  // KOF Series
  "Kyo Kusanagi":                "KOF",
  "Mai Shiranui":                "KOF",
  "Terry Bogard":                "KOF",
  ...
  "Gusion KOF":                  "KOF",
  // ALLSTAR Series
  "SPARKLE Melissa":             "ALLSTAR",
  "SPARKLE Fredrinn":            "ALLSTAR",
  "SPARKLE Estes":               "ALLSTAR",
  // Attack on Titan Collab
  "Eren":                        "Attack on Titan Collab",
  "Levi":                        "Attack on Titan Collab",
  "Mikasa":                      "Attack on Titan Collab",
  // Mistbenders Series
  "Mistbender Aldous":           "Mistbenders",
  "Mistbender Nana":             "Mistbenders",
  // Beyond the Clouds Series
  "Beyond the Clouds Kagura":    "Beyond the Clouds",
  "Beyond the Clouds Edith":     "Beyond the Clouds",
  "Beyond the Clouds Xavier":    "Beyond the Clouds",
  // Ducati Series
  "Diavel V4 Rider":             "Ducati",
  "Panigale V4S Rider":          "Ducati",
  "Monster SP Rider":            "Ducati",
  // Dawning Stars Series
  "Thunderfist":                 "Dawning Stars",
  "Firebolt":                    "Dawning Stars",
  "Swordmaster":                 "Dawning Stars",
  "Blizzard Storm":              "Dawning Stars",
  "The Foreseer":                "Dawning Stars",
  // Atomic Pop Series
  "Atomic Pop Eudora":           "Atomic Pop",
  "Atomic Pop Miya":             "Atomic Pop",
  // Jujutsu Kaisen Collab
  "Yuji Itadori":                "Jujutsu Kaisen Collab",
  "Megumi Fushiguro":            "Jujutsu Kaisen Collab",
  "Nobara Kugisaki":             "Jujutsu Kaisen Collab",
  "Satoru Gojo":                 "Jujutsu Kaisen Collab",
  // Gold Saints Series
  "Sagittarius Seiya":           "Gold Saints",
  "Libra Shiryu":                "Gold Saints",
  "Leo Ikki":                    "Gold Saints",
  // Bronze Saints Series
  "Pegasus Seiya":               "Bronze Saints",
  "Phoenix Ikki":                "Bronze Saints",
  "Dragon Shiryu":               "Bronze Saints",
  // Kung Fu Panda Collab
  "Kung Fu Panda":               "Kung Fu Panda Collab",
  "Lord Shen":                   "Kung Fu Panda Collab",
  "General Kai":                 "Kung Fu Panda Collab",
  // Heavenly Artifact Series
  "Empyrean Paladin":            "Heavenly Artifact",
  "Elysium Guardian":            "Heavenly Artifact",
  // MLBB × Transformers Collab
  "Soundwave & Ravage":          "MLBB × Transformers Collab",
  "Starscream":                  "MLBB × Transformers Collab",
  "Grimlock":                    "MLBB × Transformers Collab",
  "Optimus Prime":               "MLBB × Transformers Collab",
  "Megatron":                    "MLBB × Transformers Collab",
  "Bumblebee":                   "MLBB × Transformers Collab",
  // 515 eParty Series
  "M-World Yin":                 "515 eParty",
  "M-World Ling":                "515 eParty",
  "M-World Wanwan":              "515 eParty",
  "S.T.U.N. Chou":               "515 eParty",
  "S.T.U.N. Selena":             "515 eParty",
  "S.T.U.N. Brody":              "515 eParty",
  // MLBB × Sanrio Collab
  "Heartstring":                 "MLBB × Sanrio Collab",
  "Fluffy Dream":                "MLBB × Sanrio Collab",
  "Bad Bro":                     "MLBB × Sanrio Collab",
  "Moon Artist":                 "MLBB × Sanrio Collab",
  // MLBB × Star Wars Collab
  "Obi-Wan Kenobi":              "MLBB × Star Wars Collab",
  "Master Yoda":                 "MLBB × Star Wars Collab",
  "First Order Jet Trooper":     "MLBB × Star Wars Collab",
  "Darth Vader":                 "MLBB × Star Wars Collab",
  // Blazing Bounties Series
  "Blazing Gun":                 "Blazing Bounties",
  "Blazing Force":               "Blazing Bounties",
  "Blazing Trace":               "Blazing Bounties",
  "Blazing Axe":                 "Blazing Bounties",
  "Blazing Shadow":              "Blazing Bounties",
  // Dragon Tamer Series
  "Empyrean Flame":              "Dragon Tamer",
  "Draconic Flame":              "Dragon Tamer",
  "Frost Wing":                  "Dragon Tamer",
  "Rattan Dragon":               "Dragon Tamer",
  "Night Shade":                 "Dragon Tamer",
  "Dragon Armor":                "Dragon Tamer",
  // Lightborn Series
  "Lightborn - Striker":         "Lightborn",
  "Lightborn - Defender":        "Lightborn",
  "Lightborn - Ranger":          "Lightborn",
  "Lightborn - Inspirer":        "Lightborn",
  "Lightborn - Overrider":       "Lightborn",
  "Lightborn Striker":           "Lightborn",
  // V.E.N.O.M. Squad
  "V.E.N.O.M. Octopus":          "V.E.N.O.M. Squad",
  "V.E.N.O.M. Monitor Lizard":   "V.E.N.O.M. Squad",
  "V.E.N.O.M. Nephila":          "V.E.N.O.M. Squad",
  "V.E.N.O.M. Emperor Scorpion": "V.E.N.O.M. Squad",
  "V.E.N.O.M. Vespid":           "V.E.N.O.M. Squad",
  "V.E.N.O.M. Cobra":            "V.E.N.O.M. Squad",
  "Venom Vespid":                "V.E.N.O.M. Squad",
  // S.A.B.E.R. Squad
  "S.A.B.E.R. Regulator":        "S.A.B.E.R. Squad",
  "S.A.B.E.R. Automata":         "S.A.B.E.R. Squad",
  "S.A.B.E.R. Breacher":         "S.A.B.E.R. Squad",
  "S.A.B.E.R. Enforcer":         "S.A.B.E.R. Squad",
  "S.A.B.E.R. Savior":           "S.A.B.E.R. Squad",
  "S.A.B.E.R. Manhunter":        "S.A.B.E.R. Squad",
  // Zodiac Series
  "Leo":                         "Zodiac",
  "Aries":                       "Zodiac",
  "Aquarius":                    "Zodiac",
  ...
  "Fiend Haunter":               "Prime",
  "Cosmic Dragon":               "Prime",
  "Cosmic Finality":             "Prime",
  "Stellar Brilliance":          "Prime",
  "Cosmic Blaze":                "Prime",
  // Double 11 Series
  "Flying Swallow":              "Double 11",
  "Tesla Maniac":                "Double 11",
  "Shura":                       "Double 11",
  "Dimension Walker":            "Double 11",
  // Abyss Series
  "General Void":                "Abyss",
  "Doom Incarnate":              "Abyss",
  "Lady Vengeance":              "Abyss",
  "Shadow Knight":               "Abyss",
  // Zenith Series
  "Curse of Cinder":             "Zenith",
  "Twisted Fairytale":           "Zenith",
  // Christmas Series
  "Angelic Sonata":              "Christmas",
  "Christmas Carnival":          "Christmas",
  // Lunar Fest Series
  "Auspicious Charm":            "Lunar Fest",
  "Dawning Fortune":             "Lunar Fest",
  "Foxy Lady":                   "Lunar Fest",
  "Lion Dance":                  "Lunar Fest",
  // MPL Series
  "Biomedic":                    "MPL",
  "Cyber Ranger":                "MPL",
  "Dream Groove":                "MPL",
  "E-girl":                      "MPL",
  "Hydromancer":                 "MPL",
  "Prismatic Sentinel":          "MPL",
  "Quantum Edge":                "MPL",
  "Quantum Grip":                "MPL",
  "Quantum Vanguard":            "MPL",
  "Wind Fairy":                  "MPL",
  // Summer Series
  "Beach Sweetheart":            "Summer",
  "Lifeguard":                   "Summer",
  "Summer Breeze":               "Summer",
  "Summer Festival":             "Summer",
  "Summer Party":                "Summer",
  "Summer Sparks":               "Summer",
  "Summer Vibes":                "Summer",
  "Summer Waves":                "Summer",
  "Sun n Sand":                  "Summer",
  "Sundress":                    "Summer",
  "Sushi Master":                "Summer",
  "Yatai Waitress":              "Summer",
  // Valentine's Series
  "Cannon and Roses":            "Valentine's",
  "Dangerous Liaison":           "Valentine's",
  "Dangerous Love":              "Valentine's",
  "Gentleman Thief":             "Valentine's",
  "Guns and Roses":              "Valentine's",
  "Lady Thief":                  "Valentine's",
  "Phantom Count":               "Valentine's",
  "Phantom Countess":            "Valentine's",
  "Romantic Fantasy":            "Valentine's",
  "Sweet Fantasy":               "Valentine's",
  // Collector Skins (no series grouping — each is standalone)
  "Aeon of Twilight":            "Collector",
  "Adlaw's Chosen":              "Collector",
  "Agent Z":                     "Collector",
  "Aqua Pura":                   "Collector",
  "Astral Wanderer":             "Collector",
  "Blazing Tiger":               "Collector",
  "Blood Serpent":               "Collector",
  "Celestial Judicator":         "Collector",
  "Crimson Blast":               "Collector",
  "Crimson Wings":               "Collector",
  "Death Oath":                  "Collector",
  "Demonlord":                   "Collector",
  "Doom Catalyst":               "Collector",
  "Dragonsworn":                 "Collector",
  "Dream Caster":                "Collector",
  "Empress Phoenix":             "Collector",
  "Falcon Mistress":             "Collector",
  "Fist of Zen":                 "Collector",
  "Floral Elf":                  "Collector",
  "God of Mountains":            "Collector",
  "Light Envoy":                 "Collector",
  "Mecha Infernus":              "Collector",
  "Mecha-King Perseus":          "Collector",
  "Melody of Light":             "Collector",
  "Naraka Flame":                "Collector",
  "Night Owl":                   "Collector",
  "Ore-chemist":                 "Collector",
  "Paranormal Operative":        "Collector",
  "Pixel Blast":                 "Collector",
  "Prismatic Plume":             "Collector",
  "Psychic":                     "Collector",
  "Queen Frost":                 "Collector",
  "Realm Watcher":               "Collector",
  "Red Bastion":                 "Collector",
  "Riverland Phoenix":           "Collector",
  "Samurai Mech":                "Collector",
  "Serene Plume":                "Collector",
  "Sol Invictus":                "Collector",
  "Soulblight Tyrant":           "Collector",
  "Soulfire Netherlord":         "Collector",
  "Spirit of the Brush":         "Collector",
  "Supernal Tempest":            "Collector",
  "The Sun Empress":             "Collector",
  "Tidal Lord":                  "Collector",
  "Umbra Bloom":                 "Collector",
  "Veil of the Celestials":      "Collector",
  "Volcanic Overlord":           "Collector",
  "Warrioress Paragon":          "Collector",
  "Wicked Flames":               "Collector",
}
...
function CollectionMode({ repoFiles, imageCache, setImageCache, fetchError, selectedSkins, setSelectedSkins }) {
  ...
  // Group filtered skins by series; ungrouped go to "Other"
  const grouped = useMemo(() => {
    ...
    // Named series alphabetically, "Other" always last
  ...
  const toggleCollapse = (series) => {
    setCollapsed(prev => ({ ...prev, [series]: !prev[series] }))
  }
      ...
      <div style={{
        ...
        {TIERS.map(tier => {
          ...
          return (
            <button
              key={tier}
              onClick={() => { setActiveTier(tier); setSearch(''); setCollapsed({}) }}
              style={{
                flexShrink: 0,
              ...
              <div key={series} style={{ marginBottom: '16px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isOther ? '#12121a' : ts.bg,
                    border: `1px solid ${isOther ? '#252535' : ts.border + '66'}`,
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{
                      background: isOther ? '#1a1a2e' : ts.border + '33',
                      color: isOther ? '#555' : ts.text,
...
export default function HeroPicker({ open, onClose }) {
  ...
  const sheetStyle = {
    ...
    background: '#0e0e1a', border: '1px solid #252535',
  ...
  const handleAddToCanvas = async () => {
    ...
    const cellSize   = Math.floor(CANVAS_W / cols)
    images.forEach((img, i) => {
      updateImage(img.id, {
        x: (i % cols) * cellSize, y: Math.floor(i / cols) * cellSize,
        scaleX: cellSize / img.naturalWidth, scaleY: cellSize / img.naturalHeight,
      })
    })
    const nw = 300, nh = 400
    const newImages = selectedSkins.map((skin, i) => {
      ...
      return {
        src: skin.image,
        x: (globalIndex % cols) * cellSize,
        y: Math.floor(globalIndex / cols) * cellSize,
        naturalWidth: nw, naturalHeight: nh,
        scaleX: cellSize / nw, scaleY: cellSize / nh,
        rotation: 0, opacity: 1, name: skin.name, fileSize: 0,
      }
    })
    addImages(newImages)
    setIsAdding(false)
        ...
        <div style={overlayStyle} onClick={e => { if (e.target === e.currentTarget) handleClose() }}>
          <div style={sheetStyle}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                {selectedSkins.length > 0 && (
                  <button
                    onClick={handleAddToCanvas} disabled={isAdding}
                    style={{
            ...
            <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              ...
              {mode === 'collection' && (
                <CollectionMode
                  repoFiles={repoFiles} imageCache={imageCache}
                  setImageCache={setImageCache} fetchError={fetchError}
              ...
              {mode === 'hero' && !selectedHero && (
                <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
                  <div style={{ padding: '10px 12px', flexShrink: 0 }}>
                    <input
                      ref={heroSearchRef} type="text" placeholder="🔍 Search hero..."
                  ...
                  <div style={{ flex: 1, overflowY: 'auto', padding: '0 12px 12px' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }}>
                      {filtered.map(hero => (
                        ...
                        >
                          <img
                            src={getHeroImage(hero)} alt={hero.name}
              ...
              {mode === 'hero' && selectedHero && (
                <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
                  <div style={{ padding: '10px 12px', flexShrink: 0 }}>
                    <input
                      type="text" placeholder="🔍 Search skin..."
                      value={search} onChange={e => setSearch(e.target.value)}
                      style={{
                        width: '100%', background: '#12121a', border: '1px solid #252535',
                        borderRadius: '8px', padding: '8px 12px', color: '#fff',
                      ...
                      {selectedHero.skins
                        ...
                        .map((skin, i) => {
                          ...
                          return (
                            ...
                            >
                              <img
                                src={hasImage ? resolvedUrl : PLACEHOLDER} alt={skin.name}
                                style={{ width: '100%', height: '112px', objectFit: 'cover', display: 'block', background: '#1a1a2e' }}
                                onError={e => { e.target.src = PLACEHOLDER }}
                              />
                              {isSelected && (
