              ...
              return (
                ...
                >
                  <img
                    ...
                    alt={skin.name}
                    style={{ width: '100%', height: '68px', objectFit: 'cover', display: 'block', background: '#1a1a2e' }}
...
export default function HeroPicker({ open, onClose }) {
  ...
  // ── Add to canvas — strict 1:1 square grid, image stretched to fill ─────────
  const handleAddToCanvas = async () => {
    ...
    const cellSize   = Math.floor(CANVAS_W / cols) // square cell: width === height

    // Reposition existing images — stretch each to fill its square cell exactly
    ...
    // New skins — same square fill, no overflow, no gaps
    const nw = 300, nh = 400
