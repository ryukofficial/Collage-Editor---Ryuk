...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-void text-text overflow-hidden">
      ...
      <div id="canvas-container" className="flex-1 relative overflow-hidden" style={{ background: '#0d0d14' }}
        ...
        {!images.length && !isDragging && (
          <div style={{
            ...
            pointerEvents: 'none',
            background: 'radial-gradient(ellipse at 50% 40%, #1a1a2e 0%, #0d0d14 65%)',
          }}>
            <div style={{
