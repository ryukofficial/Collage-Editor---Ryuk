      ...
      <div id="canvas-container" className="flex-1 relative bg-grid overflow-hidden"
        ...
        {!images.length && !isDragging && (
          <div style={{
            ...
            <p style={{ color: '#c8c8e8', fontSize: '18px', fontWeight: 700, opacity: 0.25, margin: 0 }}>
              Your canvas is empty
            </p>
            <p style={{ color: '#888', fontSize: '13px', opacity: 0.3, margin: 0 }}>
              Hit <strong>+ Create</strong> to add skins, or <strong>Upload</strong> your own images
            </p>
            <div style={{
              marginTop: '8px', display: 'flex', gap: '32px', opacity: 0.12,
            }}>
              {['🖼️', '✨', '💎', '👑', '🖼️'].map((e, i) => (
